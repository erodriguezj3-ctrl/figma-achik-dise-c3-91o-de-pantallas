...
export default function Perfil() {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-figma-secondary w-full max-w-[392px] mx-auto relative font-heading">
      {/* Header */}
      ...
      <main className="flex-1 flex flex-col overflow-y-auto pb-[100px]">
        <motion.div
