  ...
  return (
    <main className="w-full max-w-[392px] mx-auto min-h-screen flex flex-col bg-figma-secondary font-heading">
      ...
      <header className="flex items-center p-6 border-b border-[#e5e7eb] w-full shrink-0">
        <button className="flex items-center gap-2 hover:opacity-70 transition-opacity focus:outline-none">
      ...
      <div className="flex flex-col flex-grow p-6 w-full">
        ...
        <div className="w-full shrink-0 mt-auto">
          <button className="w-full h-14 bg-[#04d9d9] rounded-full flex items-center justify-center hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#04d9d9]">
