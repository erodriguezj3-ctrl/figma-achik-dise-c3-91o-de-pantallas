      ...
      <div className="flex-1 flex flex-col mx-4 mb-4 rounded-[10px] shadow-[inset_0_0_0_1px_rgba(0,211,243,0.60)] bg-figma-border relative z-10 overflow-clip">
        ...
        <div className="p-4 flex flex-col gap-3 shrink-0">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => navigate(topic === "profundidad" || topic === "bokeh" ? "/FotografiaIntermedia" : topic === "tercios" ? "/PantallaDeInicio" : "/FotografiaBasica")} className="flex-1 flex justify-center items-center gap-2 py-4 bg-figma-color-9 rounded-[16px] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.30)] transition-transform active:scale-95 hover:bg-white/5">
              <span className="text-figma-16 font-bold leading-figma-24 text-figma-secondary">
                Siguiente →
              </span>
            </button>
