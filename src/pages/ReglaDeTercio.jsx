...
export default function ReglaDeTercio() {
  ...
  return (
    <div className="w-full min-h-[100dvh] bg-figma-secondary flex flex-col items-center font-heading">
      <div className="w-full max-w-[392px] flex flex-col flex-1 bg-figma-secondary relative overflow-clip shadow-2xl">
          ...
          <div className="flex flex-col flex-1 items-center justify-center w-full pb-6 min-h-[340px]">
            <div className="w-full max-w-[344px]">
              <div className="w-full min-h-[320px]">
                <VideoPlayer src={VIDEO_SOURCES.clase_composicion} className="w-full h-full min-h-[320px]" />
              </div>
            </div>
          </div>
