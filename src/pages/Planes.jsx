  ...
  return (
    <div className="w-full max-w-[392px] mx-auto bg-figma-secondary min-h-screen flex flex-col relative font-sans text-[#111827] overflow-clip">
        ...
        >
          ...
          <section className="flex flex-col gap-4">
            ...
            <motion.div variants={itemVariants} className="flex flex-col items-center p-6 bg-figma-secondary rounded-[24px] shadow-[0px_4px_6px_-4px_rgba(0,0,0,0.10),_0px_10px_15px_-3px_rgba(0,0,0,0.10),_inset_0_0_0_1px_#e5e7eb]">
              ...
              <button className="mt-5 w-full bg-[#04d9d9] text-white text-[14px] font-bold py-4 rounded-[39311300px] hover:bg-[#03c0c0] transition-colors active:scale-[0.98]">
                SUSCRIBIRME
              </button>
            </motion.div>
      ...
      <nav className="absolute bottom-0 left-0 right-0 w-full bg-figma-secondary border-t border-[#e5e7eb] min-h-[72px] flex justify-between items-center px-2 z-50 pb-safe">
        <button className="flex flex-col items-center justify-center gap-1 w-[88px] h-full group">
